...
-- ספקים מטבלת הזמנות רכש, וקבלנים מטבלת חוזי קבלן
-- מביא את התיאור מטבלת המימד ואת הסוג לפי מקור הטבלאות

-- ספקים מתוך PORDERS הזמנות רכש
SELECT DISTINCT
...
-- קבלנים מתוך MED_PORDERS חוזי קבלן
SELECT DISTINCT
